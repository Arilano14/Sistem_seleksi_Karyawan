                    ...
                    <div class="flex justify-end items-center d p-4">
                        <div class="flex space-x-3">
                            <div class="flex space-x-3 items-center">
                                <label for="add_button" class="btn btn-primary btn-sm text-white dark:text-gray-800 normal-case bg-primary hover:bg-opacity-70 hover:border-opacity-70 dark:bg-primary dark:hover:bg-opacity-90">
